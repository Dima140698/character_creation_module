...
def attack(char_name: str, char_class: str) -> str:
    """Выводит колличество нанесенного урона выбранным персонажем."""
...
def defence(char_name: str, char_class: str) -> str:
    """Выводит количествоблокированного урона выбранным персонажем."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Выводит применнное спец. умение выбранным персонажем."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Выводит имя и описание выбранного персонажа."""
    if char_class == 'warrior':
